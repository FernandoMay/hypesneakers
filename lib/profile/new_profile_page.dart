            ...
            _buildSection(
              ...
              items: [
                _buildMenuItem(
                  ...
                  title: 'My Orders',
                  onTap: () => NavigationService.navigateToOrders(context),
                ),
                _buildMenuItem(
                  icon: CupertinoIcons.location,
                  title: 'Shipping Addresses',
                  onTap: () => NavigationService.navigateToAddresses(context),
                ),
              ],
            ),
            const SizedBox(height: 24),
            _buildSection(
              ...
              items: [
                _buildMenuItem(
                  ...
                  title: 'Notifications',
                  onTap: () => NavigationService.navigateToNotifications(context),
                ),
                _buildMenuItem(
                  icon: CupertinoIcons.lock,
                  title: 'Privacy',
                  onTap: () => NavigationService.navigateToPrivacy(context),
                ),
              ],
            ),
          ],
